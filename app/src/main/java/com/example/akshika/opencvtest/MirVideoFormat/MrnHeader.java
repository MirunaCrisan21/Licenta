...
public class MrnHeader {
    ...
    public MrnHeader(byte[] buffer){
        ...
        padding = VideoFile.GetIntFromByteArray(8,buffer);
        parameter = VideoFile.GetIntFromByteArray(12,buffer);
    ...
    public byte[] ToByteArray(){
        return CreateFileHeader(delayBetweenFramesInMs,dateRate,padding,parameter,
     ...
     * @param delayBetweenFramesInMs time delay between frames in microseconds
     * @param dataRate data rate of AVI data
     * @param padding padding multiple size, typically 2048
     * @param parameter parameter flags
     ...
     * @param bufferSizeInBytes suggested playback buffer size in bytes
     ...
     * @param dateRate data rate (frame rate = data rate / time scale)
     ...
     */
    public static byte[] CreateFileHeader(int delayBetweenFramesInMs, int dataRate, int padding, int parameter,
        ...
        insertIntIntoByteArray(padding,8,result);
        insertIntIntoByteArray(parameter,12,result);
